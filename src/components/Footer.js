      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col justify-between">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <h1 className=' text-3xl'>VT</h1>
          </a>
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">Built with
            <span className='text-2xl text-red-700'> ♡ </span>
            by
            <Link href="/" className="text-pink-600 ml-1 hover:text-blue-600  sm:text-2xl" rel="noopener noreferrer"> Vinayak-Tavatam </Link>
          </p>
